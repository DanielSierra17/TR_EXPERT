...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="registrarTipoMedida.jsp">Agregar zonas del cuerpo</a>
            <a href="tiposEjercicios.jsp">Agregar Tipos de ejercicios</a>
            <a href="registrarMedidas.jsp">Registrar medidas</a>
