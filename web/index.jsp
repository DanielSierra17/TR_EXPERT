...
<body>
        ...
        <div class="modal fade" id="exampleModalAreaTri" tabindex="-1" role="dialog"
            ...
            <div class="center">
                ...
                <form method="post">
                    ...
                    <div class="pass"><a href="./formulario-validaciones.html">Â¿No tienes cuenta?<br>Â¡Registrate
                            aquÃ­!</a></div>
    ...
    <section class="about" id="about">
        ...
        <div class="content">
            ...
            <p>Es un software encargado del buen funcionamiento y gestionamiento de planes de entrenamiento a
                nivel de gimnasios, cuenta con una totalidad de 7 mÃ³dulos, de los mÃ¡s importantes que podemos resaltar
                son: Usuarios, Plan De Entrenamiento y Ejercicio; ademÃ¡s de esto TR Expert a nivel de UI y IX implementa
                interfaces modernas, dinÃ¡micas e interactivas para mejorar la experiencia usuario sistema. Si necesitas
                sistematizar los procesos de tu gimnasio TR Expert es la mejor soluciÃ³n.
            </p>
    ...
    <section class="features" id="Modulos">
        ...
        <h1 class="heading"> <span>MÃ³dulos</span> </h1>
        ...
        <div class="box-container">
            <div class="box second">
                ...
                <div class="content">
                    ...
                    <h3>Usuarios</h3>
                    <p>Permite registrar usuarios y hacer cargas masivas, por esta razÃ³n permite ser organizado y que el
                        proceso sea menos tedioso en el tema de la informaciÃ³n, asÃ­ no se perderÃ¡ ni borrarÃ¡ ningÃºn
                        dato.
                        ...
                        si el usuario quiere volver al gimnasio sÃ³lo se le cambiarÃ¡ el estado a activo.</p>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>Asigna los planes de entrenamiento apartir de las medidas registradas por el cliente. el mismo
                        ...
                        ejercicios con unas repeticones y unas series especÃ­ficas.
                        TambiÃ©n se permitirÃ¡ actualizar el plan de acuerdo con el avance del cliente, este avance se
                        evaluarÃ¡ cada tres meses y asÃ­ el entrenador decide como actualizar el plan de entrenamiento.
                    </p>
                    <a href="#" class="btn">Ingresar</a>
                </div>
            </div>
                         ...
                         <div class="form-row mb-2">
                             <div class="form-group col-md-6">
                                 <div class="formulario__grupo" id="grupo__nombre">
                                     ...
                                     <p class="formulario__input-error">El nombre debe tener mÃ­nimo 2 letras y mÃ¡ximo 40.</p>
                                 </div>
                             </div>
                             ...
                             <div class="form-group col-md-6">
                                 <div class="formulario__grupo" id="grupo__apellido">
                                     ...
                                     <p class="formulario__input-error">El apellido debe tener mÃ­nimo 2 letras y mÃ¡ximo 40.</p>
                                 </div>
                             </div>
                             ...
                             <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="formulario__grupo" id="grupo__correo">
                                        <label for="correo" class="formulario__label">TelÃ©fono</label>
                                        <div class="formulario__grupo-input">
                                            <input type="email" class="formulario__input" name="correo" id="correo" placeholder="Ingresa tu nombre">
                                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                        </div>
